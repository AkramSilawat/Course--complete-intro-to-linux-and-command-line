...
//:~$  ls /etc/cron.hourly/              
// --->  # This is where the hourly jobs are kept.

//:~$  ls/etc/cron.monthly/               
// --->   # These are the monthly jobs, usually used for things like backups

//:~$  ls/etc/cron.daily/                   
// --->   # These are the daily jobs, usually used for things like cleaning up
...
//:~/temp-files$  crontab -e                 
// --->  run this as well as root.
...
//:~/my-git-project master $ g it checkout -b another-project
